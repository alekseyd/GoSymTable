...
func (c *profileStoreServiceClient) WriteRaw(ctx context.Context, in *WriteRawRequest, opts ...grpc.CallOption) (*WriteRawResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/profilestore.ProfileStoreService/WriteRaw", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProfileStoreService_WriteRaw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/profilestore.ProfileStoreService/WriteRaw",
	}
...
var ProfileStoreService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "profilestore.ProfileStoreService",
...
func (c *agentsServiceClient) Agents(ctx context.Context, in *AgentsRequest, opts ...grpc.CallOption) (*AgentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/profilestore.AgentsService/Agents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AgentsService_Agents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/profilestore.AgentsService/Agents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AgentsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "profilestore.AgentsService",
...
func (m *Agent) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LastPushDuration != nil {
		if vtmsg, ok := interface{}(m.LastPushDuration).(interface {
	...
	if m.LastPush != nil {
		if vtmsg, ok := interface{}(m.LastPush).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
