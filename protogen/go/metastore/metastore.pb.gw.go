...
/*
Package metastore is a reverse proxy.
...
func RegisterMetastoreServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MetastoreServiceServer) error {
	...
	mux.Handle("POST", pattern_MetastoreService_GetOrCreateMappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/GetOrCreateMappings", runtime.WithHTTPPathPattern("/metastore.MetastoreService/GetOrCreateMappings"))
		if err != nil {
	...
	mux.Handle("POST", pattern_MetastoreService_GetOrCreateFunctions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/GetOrCreateFunctions", runtime.WithHTTPPathPattern("/metastore.MetastoreService/GetOrCreateFunctions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_GetOrCreateLocations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/GetOrCreateLocations", runtime.WithHTTPPathPattern("/metastore.MetastoreService/GetOrCreateLocations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_GetOrCreateStacktraces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/GetOrCreateStacktraces", runtime.WithHTTPPathPattern("/metastore.MetastoreService/GetOrCreateStacktraces"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_UnsymbolizedLocations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/UnsymbolizedLocations", runtime.WithHTTPPathPattern("/metastore.MetastoreService/UnsymbolizedLocations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_CreateLocationLines_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/CreateLocationLines", runtime.WithHTTPPathPattern("/metastore.MetastoreService/CreateLocationLines"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_Locations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/Locations", runtime.WithHTTPPathPattern("/metastore.MetastoreService/Locations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_Functions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/Functions", runtime.WithHTTPPathPattern("/metastore.MetastoreService/Functions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_Mappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/Mappings", runtime.WithHTTPPathPattern("/metastore.MetastoreService/Mappings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_Stacktraces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metastore.MetastoreService/Stacktraces", runtime.WithHTTPPathPattern("/metastore.MetastoreService/Stacktraces"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMetastoreServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MetastoreServiceClient) error {
	...
	mux.Handle("POST", pattern_MetastoreService_GetOrCreateMappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/GetOrCreateMappings", runtime.WithHTTPPathPattern("/metastore.MetastoreService/GetOrCreateMappings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_GetOrCreateFunctions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/GetOrCreateFunctions", runtime.WithHTTPPathPattern("/metastore.MetastoreService/GetOrCreateFunctions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_GetOrCreateLocations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/GetOrCreateLocations", runtime.WithHTTPPathPattern("/metastore.MetastoreService/GetOrCreateLocations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_GetOrCreateStacktraces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/GetOrCreateStacktraces", runtime.WithHTTPPathPattern("/metastore.MetastoreService/GetOrCreateStacktraces"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_UnsymbolizedLocations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/UnsymbolizedLocations", runtime.WithHTTPPathPattern("/metastore.MetastoreService/UnsymbolizedLocations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_CreateLocationLines_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/CreateLocationLines", runtime.WithHTTPPathPattern("/metastore.MetastoreService/CreateLocationLines"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_Locations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/Locations", runtime.WithHTTPPathPattern("/metastore.MetastoreService/Locations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_Functions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/Functions", runtime.WithHTTPPathPattern("/metastore.MetastoreService/Functions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_Mappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/Mappings", runtime.WithHTTPPathPattern("/metastore.MetastoreService/Mappings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_MetastoreService_Stacktraces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/metastore.MetastoreService/Stacktraces", runtime.WithHTTPPathPattern("/metastore.MetastoreService/Stacktraces"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_MetastoreService_GetOrCreateMappings_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "GetOrCreateMappings"}, ""))

	pattern_MetastoreService_GetOrCreateFunctions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "GetOrCreateFunctions"}, ""))

	pattern_MetastoreService_GetOrCreateLocations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "GetOrCreateLocations"}, ""))

	pattern_MetastoreService_GetOrCreateStacktraces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "GetOrCreateStacktraces"}, ""))

	pattern_MetastoreService_UnsymbolizedLocations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "UnsymbolizedLocations"}, ""))

	pattern_MetastoreService_CreateLocationLines_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "CreateLocationLines"}, ""))

	pattern_MetastoreService_Locations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "Locations"}, ""))

	pattern_MetastoreService_Functions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "Functions"}, ""))

	pattern_MetastoreService_Mappings_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "Mappings"}, ""))

	pattern_MetastoreService_Stacktraces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"metastore.MetastoreService", "Stacktraces"}, ""))
)
